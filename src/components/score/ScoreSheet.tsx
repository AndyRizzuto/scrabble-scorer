  ...
  <div className="bg-white border-2 border-gray-300 rounded-lg p-6 shadow-lg" style={{
    ...
    <div className="grid grid-cols-2 gap-8 mb-6 pb-4 border-b-2 border-gray-400">
      <div className="text-center">
        <h3 className="text-xl font-bold text-blue-700 underline" style={{ fontFamily: 'cursive' }}>{players.player1.name}</h3>
        {(() => {
      ...
      <div className="text-center">
        <h3 className="text-xl font-bold text-purple-700 underline" style={{ fontFamily: 'cursive' }}>{players.player2.name}</h3>
        {(() => {
